	...
	render() {
		...
		const userShow = this.state.hasLogined
			? <Menu.Item key="logout" class="register">
					...
					&nbsp;&nbsp;
					<Button type="ghost" htmlType="button" onClick={this.signout.bind(this)}>退出</Button>
				</Menu.Item>
		...
		return (
			<header>
				<Row>
					...
					<Col span={16}>
						<Menu mode="horizontal" onSelect={this.handleClick.bind(this)} selectedKeys={[this.state.current]}>
							<Menu.Item key="top">
